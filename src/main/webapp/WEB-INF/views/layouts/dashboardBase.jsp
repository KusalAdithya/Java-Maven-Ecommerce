...
<layout:extends name="base">
    ...
    <layout:put block="dashboardStyle" type="REPLACE">
        <!-- Fonts and icons -->
        ...
        <%--        <!-- CSS Files -->--%>
        <link id="pagestyle" href="dashboardAssets/css/material-dashboard.css?v=3.2.0" rel="stylesheet"/>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">

    </layout:put>

    <layout:put block="dashboardHeader" type="REPLACE">
        <%--        nothing--%>
    </layout:put>
        ...
        <div class="g-sidenav-show  bg-gray-100">
                ...
                <div class="sidenav-header">
                    <i class="fas fa-times p-3 cursor-pointer text-dark opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
                       aria-hidden="true" id="iconSidenav"></i>
                        <a class="navbar-brand  px-5  py-3  mx-auto" href="../../../ecomm/"> <img src="img/logo.png" alt="logo"> </a>
                </div>
            ...
            <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                        ...
                        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                            ...
                            <ul class="navbar-nav d-flex align-items-center  justify-content-end">
                                <li class="nav-item d-flex align-items-center">
                                    <a class="btn btn-outline-primary btn-sm mb-0 me-3"   href="/ecomm/">Store</a>
                                </li>
                                ...
                                <li class="nav-item d-flex align-items-center">
                                    <a href="javascript:" class="nav-link text-body p-0">
                                        <h6 class="mb-0  font-weight-bolder">Hi Kusal!</h6>
                                    </a>
                ...
                <div class="container container-fluid py-2">
                    ...
                    <layout:block name="body_contents">
                        <%--  Dashboard content ------------------------------------------  --%>
                    </layout:block>
...
<%--            </div>--%>
    ...
    <layout:put block="dashboardFooter" type="REPLACE">
        <%--        nothing--%>
    </layout:put>


    <layout:put block="dashboardJs" type="REPLACE">
        <!-- Core JS Files -->
        <script src="dashboardAssets/js/core/popper.min.js"></script>
        <script src="dashboardAssets/js/core/bootstrap.min.js"></script>
        <script src="dashboardAssets/js/plugins/perfect-scrollbar.min.js"></script>
        ...
        <script src="dashboardAssets/js/material-dashboard.min.js?v=3.2.0"></script>
    </layout:put>
